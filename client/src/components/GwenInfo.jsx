...
export default function Info() {
  ...
  return (
    <div className="container-sm">
      <h1 className="heroName" style={{color: 'white', textAlign:"center"}}>Spider-Gwen</h1>
      <div className="row">
        <div className="col-6">
        <p className="story">After being bitten by a <b>genetically-engineered spider</b>, Gwen was granted <b>arachnid-like super-powers</b>, and started a career as a crimefighter, dubbed by the media as <b>"Spider-Woman</b>."
